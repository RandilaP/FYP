  ...
  return (
    <header className="fixed inset-x-0 top-0 z-40">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between py-4 backdrop-blur-md bg-white/80 dark:bg-black/40 rounded-xl px-4">
          <div className="flex items-center gap-3">
            <div className="flex items-center justify-center w-10 h-10 rounded-lg bg-linear-to-br from-red-500 to-red-600 text-white shadow-md">
              <HospitalIcon className="w-5 h-5" />
            </div>
            <div>
              <a href="/" className="text-lg font-semibold text-gray-900 dark:text-gray-100">BHT System</a>
              <div className="text-sm text-gray-500 dark:text-gray-400">Sri Lanka Hospitals</div>
            </div>
          </div>
